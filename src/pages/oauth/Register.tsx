...
export default function OauthRegister() {
  ...
  const { signUpWithIDP, isLoading, error, clearError } = useAuth();
    ...
    <div style={styles.root}>
      ...
      <div style={styles.card}>
        ...
        <div>
          ...
          <p style={styles.subtitle}>Join EBS Portal to access banking solutions</p>
        </div>
        ...
        >
          {busy ? '⏳ Redirecting…' : '✨ Sign up with TickTix'}
        </button>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  linkBtn: {
    ...
    background: 'transparent', color: '#818cf8', fontSize: '0.875rem', fontWeight: 600,
